...
- **Gaining and losing possibilities**: highlight both when a driver first becomes mathematically able to win/podium, and when they are eliminated from a position.
